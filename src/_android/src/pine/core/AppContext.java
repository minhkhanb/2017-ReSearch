...
public class AppContext
{
	...
	static public void Init(Context context, Bundle savedInstanceState)
	{
		...
		if(AppConfig.UseAdmob || AppConfig.UseAdmobBanner)
		{
		...
		if(AppConfig.UseVungleAds)
		{
			try
			{
				...
				vunglePub.setEventListeners(VungleAdsManager.vungleListener);
			}
			catch(Exception ex)
			{
	...
	static public void onAppPause()
	{
		...
		//if (AppConfig.UseAdmob)
		//{
			//AdmobManager.getVideoAdsInstance().pause(CurrentContext);
		//}
	...
	static public void onAppResume()
	{
		...
		//if (AppConfig.UseAdmob)
		//{
			//AdmobManager.getVideoAdsInstance().resume(CurrentContext);
		//}
	...
	static public void onAppDestroy()
	{
		//if (AppConfig.UseAdmob)
		//{
			//AdmobManager.getVideoAdsInstance().destroy(CurrentContext);
		//}
