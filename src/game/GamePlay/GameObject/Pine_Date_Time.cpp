...
INT_TIME Pine_Date_Time::GetCurrentTotalMiliSec()
{
	INT_TIME milisec = _hour*3600*1000 + _minute * 60*1000 + _second*1000 + _milisecond;
...
INT_TIME Pine_Date_Time::GetTotalMiliSec()
{
	INT_TIME milisec = GetTotalSec()*1000 + _milisecond;
	if (_hour == 255 && _minute == 255 && _second == 255)
	{
		milisec = 0;
	}
...
INT_TIME Pine_Date_Time::GetTotalSec()
{ 
	INT_TIME sec = _day * 24 * 3600 + _hour * 3600 + _minute * 60 + _second;
	if (_hour == 255 && _minute == 255 && _second == 255)
	{
		sec = 0;
	}	
...
INT_TIME Pine_Date_Time::GetTotalMin()
{
	INT_TIME min = _day * 24 * 60 + _hour * 60 + _minute;
	if (_hour == 255 && _minute == 255 && _second == 255)
	{
		min = 0;
	}
...
const char* Pine_Date_Time::GetStringTime(INT_TIME milisecond)
{
