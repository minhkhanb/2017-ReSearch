...
void Device::GA_LogContents(const char *title, const char* decs)
{
	OS_GoogleAnalyticsLogEvent(title, decs);
}
...
void Device::GA_LogContents(const char *title,const char* decs)
{
    OS_GoogleAnalyticsLogContents(title,decs);
}
extern "C" void OS_GoogleAnalyticsLogs(const char *event_name,const char* root_name, const char* value);
void Device::GA_Logs(const char *event_name,const char* root_name, const char* value)
{
    OS_GoogleAnalyticsLogs(event_name,root_name,value);
}
