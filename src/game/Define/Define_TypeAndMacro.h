...
//ulti
#define CHECK_RECT_IN_CIRCLE(x,y,w,h,cX,cY,R)					(GAME()->CheckRectOverlapCircle(x, y, w, h, cX, cY, R))
#define CHECK_CIRCLE_IN_CIRCLE(cX1,cY1,R1,cX2,cY2,R2)			(GAME()->CheckCircleOverlapCircle(cX1, Y1, R1, cX2, cY2, R2))
#define CHECK_RECT_IN_RECT(x1,y1,w1,h1,x2,y2,w2,h2)				(GAME()->checkRectOverlapRect(x1, y1, w1, h1, x2, y2, w2, h2))

//
//new
#define MAIN_GAME()				(((ShakeDuckOffGame*)CGame::_this->_current_game))
#define USER()					(MAIN_GAME()->_user)
#define EFFECT()				(MAIN_GAME()->_effect)
