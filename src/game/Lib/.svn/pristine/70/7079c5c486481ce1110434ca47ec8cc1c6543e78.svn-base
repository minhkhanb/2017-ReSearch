...
ENUM PineServiceCode
{
	...
	AdmobBannerHide = 23,
	DialogShow = 24,
	FacebookPostScore = 25,
	TakeScreenShot = 26,
	FacebookPostScreen = 27,
	ShareScreenShotIntent = 28,
	ShareIntent = 29,
	SendEmailIntent = 30,
	GooglePlayIsLogin = 31,
	GooglePlayLogin = 32,
	GooglePlayUserInfo = 33,
	GooglePlayGetFriends = 34,
	GooglePlayPostScore = 35,
	GooglePlayGetLeaderBoardRank = 36,
	GooglePlayShowLeaderBoard = 37,
	GooglePlayShowAchievements = 38,
	GooglePlayShareToGooglePlus = 39,
	GooglePlayShareScreenToGooglePlus = 40,
	GooglePlayUnlockAchievement = 41,
	GooglePlayUpdateCloudSave = 42,
	GooglePlaySendGift = 43,

	// chartboost
	ChartboostInterstitialPrepare = 44,
	ChartboostInterstitialShow = 45,
	ChartboostRewardedVideoPrepare = 46,
	ChartboostRewardedVideoShow = 47,

	// unity3d ads 
	UnityAdsPrepareAds = 48,
	UnityAdsPrepareVideo = 49,
	UnityAdsPrepareSkippableVideo = 50,
	UnityAdsShowAd = 51,
	UnityAdsShowVideo = 52,
	UnityAdsShowSkippableVideo = 53,
	...
	FacebookAppInvite = 56,

	//firebase
	FirebaseAnalyticsLogEvent = 57,

	//Local notification
	SetLocalNotification = 58,

	//Game Spark back-end
	GameSparkLogin = 59,
	GameSparkPostScore = 60,
	GameSparkGetLeaderBoard = 61,
	GameSparkGetSave = 62,
	GameSparkUploadSave = 63,
